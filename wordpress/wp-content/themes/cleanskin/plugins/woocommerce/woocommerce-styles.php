...
if ( ! function_exists( 'cleanskin_woocommerce_get_css' ) ) {
	add_filter( 'cleanskin_filter_get_css', 'cleanskin_woocommerce_get_css', 10, 2 );
	function cleanskin_woocommerce_get_css( $css, $args ) {
...
.woocommerce:not(.single-product) ul.products li.product .post_data .post_tags a:hover,
...
.woocommerce ul.products li.product .post_data .post_tags,
.woocommerce ul.products li.product .post_data .post_tags a {
	color: {$colors['text_light']};
}
.woocommerce ul.products li.product .price, .woocommerce-page ul.products li.product .price,
...
/* Shop mode selector */
.cleanskin_shop_mode_buttons a {
	color: {$colors['alter_bg_hover']};
}
.cleanskin_shop_mode_buttons a:hover {
	color: {$colors['text_hover']};
}
.shop_mode_thumbs .cleanskin_shop_mode_buttons a.woocommerce_thumbs,
...
/* Woocommerce shop own styles */
.woocommerce .select_container {
    background-color: {$colors['bg_color_0']};
}


/* Woocommerce mini cart own styles */
...
/*Woocommerce Single Product Variations_Form own styles*/
...
.woocommerce.single-product .product .summary .variations_form .select_container select:hover {
	border-bottom-color: {$colors['input_bd_hover']}!important;
}
.woocommerce.single-product .product .summary .variations_form .select_container select:hover:before {
...
.woocommerce.single-product .product .summary .variations_form .quantity .qty {
     border-bottom-color: {$colors['text']};
     background: {$colors['bg_color_0']};
}
/*Woocommerce tabs own styles*/
.woocommerce div.product .woocommerce-tabs .tabs li:not(.active) a {
...
.single-product.woocommerce .product button.button.alt.single_add_to_cart_button.disabled {
    color: {$colors['text_hover']};
	background-color: {$colors['bg_color_0']};
	border-color: {$colors['text_hover']};
}
/*Woocommerce Tab Additional info own styles*/
.woocommerce table.shop_attributes th, .woocommerce table.shop_attributes td, .woocommerce table.shop_attributes {
    border-color: {$colors['text']};
}


/*Woocommerce Tab Comments comment list*/
.woocommerce  .commentlist li .comment-text p.meta, .woocommerce-page  .commentlist li .comment-text p.meta {
	color: {$colors['text_link']}!important;
}
.woocommerce  .commentlist li .comment-text .description p, .woocommerce-page  .commentlist li .comment-text .description p{
	color: {$colors['text_hover']};
}
...
/* Woocommerce Form Calculated Own Styles */
...
.woocommerce .cart-collaterals .woocommerce-shipping-calculator .shipping-calculator-form input:hover,
.woocommerce-page .cart-collaterals .woocommerce-shipping-calculator .shipping-calculator-form input:hover,
.woocommerce-page .checkout input:hover,
.woocommerce-page .checkout textarea:hover {
	border-bottom-color: {$colors['input_bd_hover']}; 
}
.woocommerce .cart-collaterals .woocommerce-shipping-calculator .shipping-calculator-form input:focus,
.woocommerce-page .cart-collaterals .woocommerce-shipping-calculator .shipping-calculator-form input:focus,
...
.woocommerce.single-product ul.products li.product .post_data .post_tags:hover,
.woocommerce.single-product ul.products li.product .post_data .post_tags:hover a {
	color: {$colors['alter_hover2']};
}
