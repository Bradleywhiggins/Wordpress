...
if ( ! function_exists( 'cleanskin_mailchimp_get_css' ) ) {
	add_filter( 'cleanskin_filter_get_css', 'cleanskin_mailchimp_get_css', 10, 2 );
	function cleanskin_mailchimp_get_css( $css, $args ) {
