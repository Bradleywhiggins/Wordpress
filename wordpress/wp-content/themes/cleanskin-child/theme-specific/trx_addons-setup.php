...
if ( ! function_exists( 'cleanskin_trx_addons_cv_enable' ) ) {
	//Handler of the add_filter( 'trx_addons_cv_enable', 'cleanskin_trx_addons_cv_enable');
...
if ( ! function_exists( 'cleanskin_trx_addons_demo_enable' ) ) {
	//Handler of the add_filter( 'trx_addons_demo_enable', 'cleanskin_trx_addons_demo_enable');
...
if ( ! function_exists( 'cleanskin_trx_addons_edd_themes_market_enable' ) ) {
	//Handler of the add_filter( 'trx_addons_filter_edd_themes_market', 'cleanskin_trx_addons_edd_themes_market_enable')) {
...
if ( ! function_exists( 'cleanskin_trx_addons_api_list' ) ) {
	//Handler of the add_filter('trx_addons_api_list',	'cleanskin_trx_addons_api_list');
...
if ( ! function_exists( 'cleanskin_trx_addons_cpt_list' ) ) {
	//Handler of the add_filter('trx_addons_cpt_list',	'cleanskin_trx_addons_cpt_list');
...
if ( ! function_exists( 'cleanskin_trx_addons_sc_list' ) ) {
	//Handler of the add_filter('trx_addons_sc_list',	'cleanskin_trx_addons_sc_list');
...
if ( ! function_exists( 'cleanskin_trx_addons_widgets_list' ) ) {
	//Handler of the add_filter('trx_addons_widgets_list',	'cleanskin_trx_addons_widgets_list');
...
if ( ! function_exists( 'cleanskin_trx_addons_thumb_size' ) ) {
	...
	function cleanskin_trx_addons_thumb_size( $thumb_size = '', $type = '' ) {
		...
		//          $thumb_size = cleanskin_get_thumb_size('big');
		return $thumb_size;
	}
}
...
if ( ! function_exists( 'cleanskin_trx_addons_meta_box_fields' ) ) {
	add_filter( 'trx_addons_filter_meta_box_fields', 'cleanskin_trx_addons_meta_box_fields', 10, 2 );
	function cleanskin_trx_addons_meta_box_fields( $mb, $post_type ) {
