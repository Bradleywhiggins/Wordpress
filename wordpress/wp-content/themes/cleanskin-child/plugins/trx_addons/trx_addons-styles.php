...
if ( !function_exists( 'cleanskin_trx_addons_add_theme_vars' ) ) {
	add_filter( 'cleanskin_filter_add_theme_vars', 'cleanskin_trx_addons_add_theme_vars', 10, 2 );
	function cleanskin_trx_addons_add_theme_vars( $rez, $vars ) {
...
if ( !function_exists( 'cleanskin_trx_addons_get_css' ) ) {
	add_filter( 'cleanskin_filter_get_css', 'cleanskin_trx_addons_get_css', 10, 2 );
	function cleanskin_trx_addons_get_css( $css, $args ) {
...
.sc_slider_controller_info, .trx_addons_dropcap_style_1, .trx_addons_dropcap_style_2 {
...
.trx_addons_tooltip:after {
	border-top-color: {$colors['alter_bg_hover']};
}
...
.sc_action.sc_action_simple .sc_item_title.sc_action_title {
	color:{$colors['extra_text']};	
}
.sc_action.sc_action_default .sc_item_title.sc_action_title {
	color:{$colors['alter_link2']};	
}
.sc_action_item.sc_action_item_simple .sc_action_item_link.sc_button { 
...
.sc_action_item.sc_action_item_default .sc_action_item_link.sc_button { 
	border-color:{$colors['alter_link2']};
	color:{$colors['alter_link2']};	
}
.sc_action_item.sc_action_item_default .sc_action_item_link.sc_button:hover { 
	background-color:{$colors['text_link']};
	color:{$colors['extra_text']};
	border-color:{$colors['text_link']};	
}
...
.comments_form .comments_field .sc_form_field_wrap input[type=text],
.comments_form .comments_field .sc_form_field_wrap textarea{
    background-color: {$colors['bg_color']};
    border-bottom-color: {$colors['input_bd_color']};
}
.wpcf7 input:not([type="submit"]):hover, .wpcf7 textarea:hover,
.sc_form input:hover,
.sc_form_field.sc_form_field_message.sc_form_field_textarea textarea:hover,
.comments_form .comments_field .sc_form_field_wrap input[type=text]:hover,
.comments_form .comments_field .sc_form_field_wrap textarea:hover {
    border-color: {$colors['input_bd_hover']};
}
.sc_form.sc_form_default input:focus, 
.sc_form_field.sc_form_field_message.sc_form_field_textarea textarea:focus,
.comments_form .comments_field .sc_form_field_wrap input[type=text]:focus,
.comments_form .comments_field .sc_form_field_wrap textarea:focus {
    border-color: {$colors['input_dark']};
}
.sc_form .sc_form_field.sc_form_field_button.sc_form_field_submit button{
    color: {$colors['text_hover']};
    border-color: {$colors['input_bd_hover']}!important;
}
.sc_form .sc_form_field.sc_form_field_button.sc_form_field_submit button:hover{
    color: {$colors['inverse_link']};
    background-color: {$colors['extra_bg_color']};
}
...
.sc_googlemap_content p a {
	color: {$colors['text_link2']};
}
.sc_googlemap_content p a:hover {
	color: {$colors['text_link']};
}
/*Icons*/
...
.sc_price_item .sc_price_item_info .sc_price_item_description {
	order: 3;
}
...
.sc_services_list .sc_services_item_icon {
	color: {$colors['text_link']};
	background-color: {$colors['bg_color_06']};
}
.with_body_paddings .sc_services_default .sc_services_item_featured_left .sc_services_item_icon,
.with_body_paddings .sc_services_default .sc_services_item_featured_right .sc_services_item_icon,
.with_body_paddings .sc_services_list .sc_services_item_icon {
	color: {$colors['extra_text']};
...
/* Services Own Styles*/
/* Single Service OWn Styles*/
.services_page_tabs.trx_addons_tabs .trx_addons_tabs_titles li.ui-state-active > a,
.services_page_tabs.trx_addons_tabs .trx_addons_tabs_titles li > a:hover,
...
.services_page_tabs.trx_addons_tabs .services_page_section textarea,
.services_page_tabs.trx_addons_tabs .services_page_section input:not([type="submit"]) {
...
.sc_testimonials_slider.slider_outer .sc_testimonials_item {
	border-color: {$colors['text_light']};
}
.sc_testimonials_slider .slider-slide:before,
...
.sc_testimonials_slider.slider_outer .slider_prev,
.sc_testimonials_slider.slider_outer .slider_next {
	background-color: {$colors['bg_color_0']};
	color: {$colors['text_light']};
}
.sc_testimonials_slider.slider_outer .slider_prev:hover,
.sc_testimonials_slider.slider_outer .slider_next:hover {
	background-color: {$colors['bg_color_0']};
}
.sc_testimonials_slider.slider_outer .slider_prev:hover:before,
.sc_testimonials_slider.slider_outer .slider_next:hover:before {
	color: {$colors['text_hover']};
}
...
.sc_team_default .sc_team_item_socials .social_item .social_icon:hover,
...
/*Titles own styles*/
.sc_title .sc_title_title, .sc_title .sc_title_descr {
    color: {$colors['text_dark']};
}

.sc_title.color_style_dark .sc_title_title{
	color: {$colors['extra_text']};
}
...
/*Menu hovers*/
header .sc_layouts_row_type_narrow .sc_layouts_menu_nav li a:hover span,
header .sc_layouts_row_type_narrow .sc_layouts_menu_nav li.current-menu-item > a > span,
header .sc_layouts_row_type_narrow .sc_layouts_menu_nav > li.menu-item-has-children.current-menu-item > a:after,
header .sc_layouts_row_type_narrow .sc_layouts_menu_nav > li.menu-item-has-children > a:hover:after {
	color: {$colors['extra_text']}!important;
}
.sc_layouts_menu_nav > li li.current-menu-item > a span,
.sc_layouts_menu_nav > li li.current-menu-parent > a span,
.sc_layouts_menu_nav > li li.current-menu-ancestor > a span,
.sc_layouts_menu_nav > li li.current-menu-ancestor > a:after {
	color: {$colors['text_link']}!important;
}
/*Header type narrow icons*/

header .sc_layouts_row_type_narrow .search_wrap .search_submit:before, 
header .sc_layouts_row_type_narrow span:before,
header .sc_layouts_row_type_narrow .sc_layouts_cart_summa {
	color: {$colors['alter_bg_hover']}!important;
}


header ul:not(.sub-menu) > li a:not(.trx_addons_login_link):hover span:after,
header ul:not(.sub-menu) > li.current-menu-item > a > span:after {
	background-color: {$colors['alter_bg_color']};
}
header .sc_layouts_row_type_narrow ul.sub-menu > li.sfHover > a:after,
header .sc_layouts_row_type_narrow ul.sub-menu > li.sfHover > a > span {
	color: {$colors['bg_color']};
}
header .sc_layouts_row_type_narrow ul.sub-menu > li > a:hover:after {
	color: {$colors['bg_color']}!important;
}
.sc_layouts_row_type_narrow ul:not(.sub-menu) > li a:not(.trx_addons_login_link):hover span:after,
header .sc_layouts_row_type_narrow ul:not(.sub-menu) > li.current-menu-item > a > span:after {
	background-color: {$colors['extra_text']};
}

header .sc_layouts_row_type_narrow .search_form:hover .search_submit:before, 
header .sc_layouts_row_type_narrow .sc_layouts_iconed_text:hover span:before,
header .sc_layouts_row_type_narrow .sc_layouts_iconed_text_link:hover span:before,
header .sc_layouts_row_type_narrow .trx_addons_login_link:hover span:before,
header .sc_layouts_row_type_narrow .sc_layouts_cart:hover span:before,
header .sc_layouts_row_type_narrow .social_item:hover > span > span:before {
	color: {$colors['text_link']}!important;
} 

header .sc_layouts_row_type_narrow .sc_layouts_iconed_text:hover span + span > span ,
header .sc_layouts_row_type_narrow .sc_layouts_cart:hover span + span > span {
	color: {$colors['extra_text']};
}
/*Button*/
...
header .sc_layouts_row_type_narrow .sc_layouts_menu_nav > li ul {
	background-color: {$colors['extra_link2']}!important;
}

header .sc_layouts_row_type_narrow ul > li ul >li a:hover span{
	color: {$colors['text_link']}!important;
}
...
header .sc_layouts_row_type_normal li.current-menu-item > a > span,
header .sc_layouts_row_type_compact li.current-menu-item > a > span {
	color: {$colors['alter_dark']};
}
header .sc_layouts_row_type_compact ul.sub-menu > li.sfHover > a:after,
header .sc_layouts_row_type_compact ul.sub-menu > li.sfHover > a > span,
header .sc_layouts_row_type_normal ul.sub-menu > li.sfHover > a:after,
header .sc_layouts_row_type_normal ul.sub-menu > li.sfHover > a > span {
	color: {$colors['text_link']};
}
header .sc_layouts_row_type_compact ul.sub-menu > li > a:hover:after,
header .sc_layouts_row_type_normal ul.sub-menu > li > a:hover:after {
	color: {$colors['text_link']}!important;
}
header .sc_layouts_row_type_normal nav ul li > a:hover > span,
header .sc_layouts_row_type_compact nav ul li > a:hover > span {
	color: {$colors['text_dark']}!important;
}
header .scheme_self.sc_layouts_row_type_normal nav ul li > a:hover > span,
header .scheme_self.sc_layouts_row_type_compact nav ul li > a:hover > span {
	color: {$colors['text_dark']}!important;
}


header .sc_layouts_row_type_normal nav ul li > a:hover:after,
header .sc_layouts_row_type_compact nav ul li > a:hover:after,
header .scheme_self.sc_layouts_row_type_normal nav ul li > a:hover:after,
header .scheme_self.sc_layouts_row_type_compact nav ul li > a:hover:after {
	color: {$colors['text_dark']};
}
header .sc_layouts_row_type_normal ul:not(.sub-menu) > li a:not(.trx_addons_login_link):hover span:after,
header .sc_layouts_row_type_normal ul:not(.sub-menu) > li.current-menu-item > a > span:after,
header .sc_layouts_row_type_compact ul:not(.sub-menu) > li a:not(.trx_addons_login_link):hover span:after,
header .sc_layouts_row_type_compact ul:not(.sub-menu) > li.current-menu-item > a > span:after,
header .scheme_self.sc_layouts_row_type_normal ul:not(.sub-menu) > li a:not(.trx_addons_login_link):hover span:after,
header .scheme_self.sc_layouts_row_type_normal ul:not(.sub-menu) > li.current-menu-item > a > span:after,
header .sc_layouts_row_type_compact li.current-menu-ancestor > a > span:after {
	background-color: {$colors['text_hover2']};
}
header .scheme_self.sc_layouts_row_type_compact ul:not(.sub-menu) > li a:not(.trx_addons_login_link):hover span:after,
header .scheme_self.sc_layouts_row_type_compact ul:not(.sub-menu) > li.current-menu-item > a > span:after,
header .scheme_self.sc_layouts_row_type_compact li.current-menu-ancestor > a > span:after {
	background-color: {$colors['extra_text']};
}
header .sc_layouts_row_type_normal ul ul,
header .sc_layouts_row_type_compact ul ul {
	background-color: {$colors['alter_bg_color']};
	
}
header .sc_layouts_row_type_normal ul ul li a span,
header .sc_layouts_row_type_compact ul ul li a span { 
	color: {$colors['text']};
}
...
header .sc_layouts_row_type_normal .widget_socials .social_icon span:before {
	color: {$colors['extra_text']};
}
header .sc_layouts_row_type_normal .widget_socials .social_icon:hover {
	background-color: {$colors['text_hover']}; 
...
header .sc_layouts_row_type_normal .sc_layouts_search .search_form:hover input {
	border-color: {$colors['text_link']}; 

}
header .sc_layouts_row_type_normal .sc_layouts_search .search_form:hover button:before {
	color: {$colors['text_hover']}; 
}
...
header .sc_layouts_row_type_compact .sc_layouts_search .search_form:hover button:before {
	color: {$colors['text_hover']}; 
}
/*Blocks with icons*/

header .sc_layouts_row_type_normal .sc_layouts_iconed_text_link span:not(.trx_addons_icon-menu):before,
header .sc_layouts_row_type_normal .trx_addons_login_link span:not(.trx_addons_icon-menu):before,
header .sc_layouts_row_type_normal .sc_layouts_cart span:not(.trx_addons_icon-menu):before {
	color: {$colors['text_link']}; 
}
header .sc_layouts_row_type_normal .sc_layouts_iconed_text_link:hover span:before,
header .sc_layouts_row_type_normal .trx_addons_login_link:hover span:before,
header .sc_layouts_row_type_normal .sc_layouts_cart:hover span:before,
header .sc_layouts_row_type_compact .sc_layouts_iconed_text_link:hover span:before,
header .sc_layouts_row_type_compact .trx_addons_login_link:hover span:before,
header .sc_layouts_row_type_compact .sc_layouts_cart:hover span:before {
	color: {$colors['text_hover']}; 
}
header .sc_layouts_row_type_normal .sc_layouts_item_details_line1 {
	color: {$colors['text']};
}
header .sc_layouts_row_type_normal .sc_layouts_item > div:hover .sc_layouts_item_details_line1 {
	color: {$colors['text_hover']};
}
...
header .sc_layouts_row_type_normal .sc_layouts_menu_nav > li ul, 
header .sc_layouts_row_type_compact .sc_layouts_menu_nav > li ul {
	background-color: {$colors['alter_bg_color']}!important;
}
header .sc_layouts_row_type_normal ul > li ul >li.menu-item-has-children a:after,
header .sc_layouts_row_type_compact ul > li ul >li.menu-item-has-children a:after {
	color: {$colors['text']}; 
}

header .sc_layouts_row_type_normal ul > li ul >li a:hover span,
header .sc_layouts_row_type_compact ul > li ul >li a:hover span {
	color: {$colors['text_link']}!important;
}
header .sc_layouts_row_type_compact .sc_layouts_menu_mobile_button_burger span:before {
	color: {$colors['text_light']}; 
}

/*Header Default Own Styles*/


header .sc_content .sc_layouts_row_type_compact .sc_layouts_iconed_text_link span:before,
header .sc_content .sc_layouts_row_type_compact .trx_addons_login_link span:before,
header .sc_content .sc_layouts_row_type_compact .sc_layouts_cart span:before,
header .sc_content .scheme_self.sc_layouts_row_type_compact .sc_layouts_iconed_text_link span:before,
header .sc_content .scheme_self.sc_layouts_row_type_compact .trx_addons_login_link span:before,
header .sc_content .scheme_self.sc_layouts_row_type_compact .sc_layouts_cart span:before {
	color: {$colors['alter_dark']}; 
}
header .sc_content .scheme_self.sc_layouts_row_type_compact .sc_layouts_iconed_text_link span,
header .sc_content .scheme_self.sc_layouts_row_type_compact .trx_addons_login_link span,
header .sc_content .scheme_self.sc_layouts_row_type_compact .sc_layouts_cart span {
	color: {$colors['alter_dark']}; 
}
header .sc_content .sc_layouts_row_type_compact .sc_layouts_cart .sc_layouts_cart_items_short {
	background-color: {$colors['text_hover']}; 
}
header .sc_content .scheme_self.sc_layouts_row_type_compact .sc_layouts_cart .sc_layouts_cart_items_short {
	background-color: {$colors['extra_text']}; 
	color: {$colors['bg_color']}; 
}
header .sc_content .sc_layouts_row_type_compact .sc_layouts_iconed_text_link:hover span:before,
header .sc_content .sc_layouts_row_type_compact .trx_addons_login_link:hover span:before,
header .sc_content .sc_layouts_row_type_compact .sc_layouts_cart:hover span:not(.sc_layouts_cart_widget_close):before {
	color: {$colors['text_link']}; 
}
...
footer .widget_socials .social_item .social_icon span:before {
	color: {$colors['extra_text']};
}
...
.trx_addons_popup_form .trx_addons_popup_form_field:not(.trx_addons_popup_form_field_submit) input:hover {
	border-bottom-color: {$colors['input_bd_hover']}; 
}
.trx_addons_popup_form .trx_addons_popup_form_field:not(.trx_addons_popup_form_field_submit) input:focus {
	border-bottom-color: {$colors['input_dark']}; 
}
.trx_addons_popup button.mfp-close:hover{
	background-color: {$colors['bg_color_0']}; 
	color: {$colors['text_link']}; 
