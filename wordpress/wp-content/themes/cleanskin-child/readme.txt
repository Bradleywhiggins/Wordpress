...
You can install it from the menu 'Appearance->Install plugins' or on the page 'Appearance->About CleanSkin'.
Please install and activate it before starting to use the theme CleanSkin.
...
Theme documentation is available on http://cleanskin.ancora.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in CleanSkin is Fontello.
