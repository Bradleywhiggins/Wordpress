						...
						<div class="comment_content">
							<div class="comment_info">
								...
								<div class="comment_posted">
									...
									<?php
										echo esc_html( get_comment_date( get_option( 'date_format' ) ) ); //cleanskin_get_date(get_comment_date('U'))
									?>
									</span>
...
if ( have_comments() || comments_open() ) {
	...
	if ( have_comments() ) {
		...
		<div id="comments" class="comments_list_wrap">
			...
			?>
		<?php echo esc_html( _n( 'Comment', 'Comments', $cleanskin_post_comments, 'cleanskin' ) ); ?></h4>
				...
				'cleanskin_filter_comment_form_args', array(
					...
					'fields'               => array(
						'author' => cleanskin_single_comments_field(
							array(
								...
								'field_name'        => 'author',
								'field_title'       => esc_html__( 'Name', 'cleanskin' ),
								'field_placeholder' => esc_html__( 'Your Name', 'cleanskin' ),
							)
						),
						'email'  => cleanskin_single_comments_field(
							array(
								...
								'field_name'        => 'email',
								'field_title'       => esc_html__( 'E-mail', 'cleanskin' ),
								'field_placeholder' => esc_html__( 'Your E-mail', 'cleanskin' ),
							)
						),
					),
					...
					'comment_field'        => cleanskin_single_comments_field(
						array(
							...
							'field_value'       => '',
							'field_name'        => 'comment',
							'field_title'       => esc_html__( 'Comment', 'cleanskin' ),
							'field_placeholder' => esc_html__( 'Your comment', 'cleanskin' ),
						)
					),
				)
			);
