...
if ( ! function_exists( 'cleanskin_admin_notice' ) ) {
	//Handler of the add_action('admin_notices', 'cleanskin_admin_notice', 2);
...
if ( ! function_exists( 'cleanskin_callback_hide_admin_notice' ) ) {
	//Handler of the add_action('wp_ajax_cleanskin_hide_admin_notice', 'cleanskin_callback_hide_admin_notice');
...
if ( ! function_exists( 'cleanskin_save_activation_date' ) ) {
	//Handler of the add_action('after_switch_theme', 'cleanskin_save_activation_date');
...
if ( ! function_exists( 'cleanskin_rate_notice' ) ) {
	//Handler of the add_action('admin_notices', 'cleanskin_rate_notice', 2);
...
if ( ! function_exists( 'cleanskin_callback_hide_rate_notice' ) ) {
	//Handler of the add_action('wp_ajax_cleanskin_hide_rate_notice', 'cleanskin_callback_hide_rate_notice');
...
if ( ! function_exists( 'cleanskin_admin_footer' ) ) {
	//Handler of the add_action('admin_footer', 'cleanskin_admin_footer');
...
if ( ! function_exists( 'cleanskin_admin_scripts' ) ) {
	//Handler of the add_action("admin_enqueue_scripts", 'cleanskin_admin_scripts');
	function cleanskin_admin_scripts() {
		...
		if ( is_object( $screen ) ) {
			if ( cleanskin_options_allow_override( ! empty( $screen->post_type ) ? $screen->post_type : $screen->id ) ) {
				...
				wp_enqueue_style( 'cleanskin-icons-animation', cleanskin_get_file_url( 'css/font-icons/css/animation.css' ), array(), null );
				// Load theme fonts
...
if ( ! function_exists( 'cleanskin_admin_localize_scripts' ) ) {
	//Handler of the add_action("admin_footer", 'cleanskin_admin_localize_scripts');
...
if ( ! function_exists( 'cleanskin_register_plugins' ) ) {
	//Handler of the add_action('tgmpa_register', 'cleanskin_register_plugins');
