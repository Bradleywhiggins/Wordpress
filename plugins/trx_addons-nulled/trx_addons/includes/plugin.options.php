...
if (!function_exists('trx_addons_init_settings')) {
	...
	function trx_addons_init_settings() {
		...
		$TRX_ADDONS_STORAGE['settings'] = apply_filters('trx_addons_init_settings', array(
			...
			'icons_selector' => 'vc',
			// Type of Instagram app: internal|client - Use internal Instagram App or user must create own application to display photos from his account
			'instagram_app' => 'internal',
