...
if ( ! function_exists( 'cleanskin_customizer_get_css' ) ) {

	function cleanskin_customizer_get_css( $args = array() ) {
		...
		if ( $fonts ) {
			...
			$fonts = cleanskin_customizer_add_theme_fonts( $fonts );
...
/* Menu mobile own styles*/
.menu_mobile_inner .search_mobile .search_field {
	{$fonts['h1_font-family']}
}

CSS;
			$rez          = apply_filters( 'cleanskin_filter_get_css', $rez, array( 'fonts' => $fonts ) );
			$css['fonts'] = $rez['fonts'];
		}
		...
		if ( $vars ) {
			...
			/* Make theme-specific fonts rules */
			$vars = cleanskin_customizer_add_theme_vars( $vars );
			extract( $vars );
...
CSS;
			$rez          = apply_filters( 'cleanskin_filter_get_css', $rez, array( 'vars' => $vars ) );
			$css['vars']  = $rez['vars'];
		}
		...
		--------------------------------------*/
		if ( false !== $colors ) {
			$schemes = empty( $scheme ) ? array_keys( cleanskin_get_sorted_schemes() ) : array( $scheme );
			...
			if ( count( $schemes ) > 0 ) {
				...
				foreach ( $schemes as $s ) {
					/* Prepare colors */
					if ( empty( $scheme ) ) {
						$colors = cleanskin_get_scheme_colors( $s );
					}

					/* Make theme-specific colors and tints */
					$colors = cleanskin_customizer_add_theme_colors( $colors );
...
.wp-caption-overlay .wp-caption .wp-caption-dd {
	...
	background-color: {$colors['text_dark_06']};
}
...
footer.scheme_self .select_container select,
footer.scheme_self .select_container:after,
footer.scheme_self strong {
	color: {$colors['inverse_link']};
}
footer.scheme_self input[type="search"] {
	background-color: {$colors['bg_color_0']};
	color: {$colors['inverse_link']};
}
.select2-dropdown,
...
.sc_layouts_title_breadcrumbs {
	color: {$colors['extra_bg_hover']} !important;
}
...
header.scheme_self ~ .menu_mobile > .menu_mobile_inner {
...
.menu_mobile_inner .search_mobile .search_field::-webkit-input-placeholder { /* Chrome/Opera/Safari */
	color: {$colors['extra_text']};
}
.menu_mobile_inner .search_mobile .search_field::-moz-placeholder { /* Firefox 19+ */
	color: {$colors['extra_text']};
}
.menu_mobile_inner .search_mobile .search_field:-ms-input-placeholder { /* IE 10+ */
	color: {$colors['extra_text']};
}
.menu_mobile_inner .search_mobile .search_field:-moz-placeholder { /* Firefox 18- */
	color: {$colors['extra_text']};
}
.menu_mobile .search_mobile .search_submit:before {
	color: {$colors['extra_text']};
}
.menu_mobile_inner .search_mobile .search_field:focus {
	border-color: {$colors['text_link']};
}
.menu_mobile_inner .search_mobile .search_field:focus + .search_submit:before {
	color: {$colors['text_link']};
}
/* Menu hovers */
...
.sc_layouts_cart_widget .sc_layouts_cart_widget_close:hover:before {
	color: {$colors['inverse_bd_hover']}!important;
}
...
.cleanskin_tabs .cleanskin_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.mptt-navigation-tabs li.active a,
.cleanskin_tabs .cleanskin_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.sheme_self.sidebar .cleanskin_tabs .cleanskin_tabs_titles li a {
	color: {$colors['alter_dark']};
	background-color: {$colors['alter_bg_hover']};
}
.sheme_self.sidebar div.esg-filter-wrapper .esg-filterbutton > span:hover,
.sheme_self.sidebar .mptt-navigation-tabs li a:hover,
.sheme_self.sidebar .cleanskin_tabs .cleanskin_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['alter_link']};
}
...
.sheme_self.sidebar .cleanskin_tabs .cleanskin_tabs_titles li.ui-state-active a {
...
.slider_prev.swiper-button-prev:hover:before, .slider_next.swiper-button-next:hover:before {
	color: {$colors['text']};
}
...
.post_layout_chess .mejs-controls .mejs-time {
    color: {$colors['text_link']};
}
.mejs-controls .mejs-button > button {
...
.mejs-controls .mejs-time-rail .mejs-time-loaded {
    background: {$colors['extra_bg_color_05']}; 
}
...
.format-video .post_featured.with_thumb .post_video_hover:hover {
	color: {$colors['text_link']};
	background-color: {$colors['extra_bg_hover_05']};
}
...
/*Single post and post own styles*/
...
.post_meta.post_meta_single .post_meta_item.post_tags a{
    color: {$colors['text']};
}
.post_meta.post_meta_single .post_meta_item.post_tags a:hover{
    color: {$colors['text_hover']};
}
...
footer.scheme_self .widget_rss .rss-date {
	color: {$colors['text_link']};
}
footer.scheme_self .widget_rss .rssSummary,
footer.scheme_self .widget_rss cite {
	color: {$colors['text_light']};
}
/* Tag cloud */
.sc_edd_details .downloads_page_tags .downloads_page_data > a,
...
.sidebar .widget .select_container:focus:before, 
.sidebar .widget .select_container:hover:before {
	background-color: {$colors['bg_color_0']};
}
...
/*Widget categories own styles*/
.widget_categories ul > li:before, .sidebar .widget_meta ul li:before {
	color: {$colors['text_link']};
}

/*Widget search own styles*/
...
.sidebar .widget_search .search-form .search-field:-ms-input-placeholder {
    color: {$colors['inverse_link']};
}
.sidebar .widget_search .search-form .search-field::placeholder {
    color: {$colors['inverse_link']};
}
footer.scheme_self .widget_search .search-form .search-field::-webkit-input-placeholder {
    color: {$colors['inverse_link']};
}
footer.scheme_self .widget_search .search-form .search-field::-moz-placeholder {
    color: {$colors['inverse_link']};
}
footer.scheme_self .widget_search .search-form .search-field:-ms-input-placeholder {
    color: {$colors['inverse_link']};
}
footer.scheme_self .widget_search .search-form .search-field::placeholder {
    color: {$colors['inverse_link']};
}
/*Widget comments own styles*/
...
/*Comments*/
.sidebar .widget_calendar td#prev a:before, .sidebar .widget_calendar td#next a:before, .sidebar .widget_calendar td#next a:after {
	background-color: {$colors['alter_bg_color']};
}
...
/* Recent Posts */
.sidebar .widget_recent_posts .post_info .post_info_item a {
 	color: {$colors['text_link']};
}
...
footer .vc_wp_text p a {
	color: {$colors['alter_link2']};
}
footer .vc_wp_text p a:hover {
	color: {$colors['text_link']};
}
...
.mc4wp-form .mc4wp-form-fields input[type="text"]::-webkit-input-placeholder { /* Chrome/Opera/Safari */
	color: {$colors['extra_text']};
}
.mc4wp-form .mc4wp-form-fields input[type="text"]::-moz-placeholder { /* Firefox 19+ */
	color: {$colors['extra_text']};
}
.mc4wp-form .mc4wp-form-fields input[type="text"]:-ms-input-placeholder { /* IE 10+ */
	color: {$colors['extra_text']};
}
.mc4wp-form .mc4wp-form-fields input[type="text"]:-moz-placeholder { /* Firefox 18- */
	color: {$colors['extra_text']};
}
...
.cleanskin_custom_hover a:hover,
.cleanskin_custom_hover a span:hover {
...
CSS;
					...
					$rez            = apply_filters(
						'cleanskin_filter_get_css', $rez, array(
							'colors' => $colors,
							'scheme' => $s,
						)
					);
		...
		return apply_filters( 'cleanskin_filter_prepare_css', $css_str, $remove_spaces );
	}
}